...
class ForgotPasswordController extends GetxController {
  ...
  bool isPasswordValid() {
    ...
    if (this.password.text == "") {
      isValid = false;
      passwordErr.value = "新パスワードを入力してください。";
    } else if (this.password.text.length < 8 ||
        this.password.text.length > 32) {
      isValid = false;
      passwordErr.value = "新パスワードは8～32文字以内で入力してください。";
    } else if (this.password.text.contains(" ")) {
      isValid = false;
      passwordErr.value = "新パスワードは半角英数字で入力してください。";
      ...
      isValid = false;
      passwordErr.value = "新パスワードは英字、数字、記号のうち2種類以上を混在させてください。";
    }
