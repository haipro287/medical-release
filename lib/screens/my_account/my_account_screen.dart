...
class MyAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // var userInfo = jsonDecode(myAccountController.getUserInfo().toString());
    //
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  myAccountController.alphabetName.value =
                      userInfo['romanji'] ?? "";
                  myAccountController.dob.value = userInfo['birthday'] ?? "";
                          ...
                          child: Column(
                            children: [
                              ...
                              myAccountField(
                                ...
                                myAccountText(myAccountController.dob.value),
                              ),
                              myAccountField(
                                Column(
                                  ...
                                  children: [
                                    ...
                                    verifiedIcon(
                                        myAccountController.emailVerified),
                                  ],
                                ),
                              ...
                              myAccountField(
                                Column(
                                  ...
                                  children: [
                                    ...
                                    verifiedIcon(
                                        myAccountController.phoneVerified),
                                  ],
                                ),
                                myAccountText(
                                    myAccountController.phoneNumber.value),
